...
<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php
            echo form_open_multipart('walikelas/edit', 'role="form" class="form-horizontal"');
              // $gurunya = $wali['username_guru']
            ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="hidden" name="id_wali" value="<?php echo $wali['id_walikelas'];?>"  id="form-field-1" class="form-control">
                <select class="form-control" name="ta">
                    <?php foreach($tahun_akademik as $tahun)
                    {
                    ?>
                        <option value="<?php echo $tahun->id_tahun_akademik?>"<?php if( $tahun->id_tahun_akademik==$wali['id_tahun_akademik']) echo 'selected="selected"';?>><?php echo $tahun->tahun_akademik?></option>
                    <?php
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="guru">
                    ...
                    {
                    ?>
                        <option value="<?php echo $guru->username?>"<?php if( $guru->username==$wali['username_guru']) echo 'selected="selected"';?>><?php echo $guru->nama_guru?></option>
                    <?php
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
               ...
               <select class="form-control" name="rombel">
                    ...
                    {
                    ?>
                        <option value="<?php echo $rombel->id_rombel?>"<?php if( $rombel->id_rombel==$wali['id_rombel']) echo 'selected="selected"';?>><?php echo $rombel->nama_rombel?></option>
                    <?php
                    }
                    ?>
                </select>
