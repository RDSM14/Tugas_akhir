            ...
            <table class="table table-bordered">
                ...
                foreach ($jadwal->result() as $row){
                    echo "<tr>
                        ...
                        <td>$row->nama_guru</td>
                        <td>".anchor('nilai/lihatNilaiSiswa/'.$row->id_jadwal."/". $row->id_mapel."/". get_tahun_akademik_aktif('id_tahun_akademik'),'<i class="fa fa-eye" aria-hidden="true"></i>',"title='Lihat Kelas'")."</td>
                        </tr>";
                    $no++;
                }
                ?>
